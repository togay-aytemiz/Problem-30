...
export default function AddUsers() {
  ...
  function handleDeleteUser(userToDelete) {
    const newUserList = userList.filter((user) => user.id !== userToDelete.id)
  ...
  return (
    <div className='mx-auto p-8 max-w-lg'>
      ...
      <div className='mt-10'>
        {userList.length === 0 ? (<h3 className='text-sm font-medium text-gray-500'>
          Hiç ekip üyesi eklemediniz
        </h3>) : (<h3 className='text-sm font-medium text-gray-500'>
